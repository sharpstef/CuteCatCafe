...
VALUES
((SELECT customerID FROM Customers WHERE firstName='Maeve' AND lastName='Smith'), (SELECT roomID FROM Rooms WHERE name='Yellow Room'), 20.00, '2021-02-15 12:00:00', 120),
((SELECT customerID FROM Customers WHERE firstName='Yu' AND lastName='Han'), (SELECT roomID FROM Rooms WHERE name='Yellow Room'), 10.00, '2021-02-15 15:00:00', 60),
